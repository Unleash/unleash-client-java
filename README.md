...
| `backupFile`                               | The path to the file where [local backups](#local-backup) get stored.                                                                                               | No       | `"java.io.tmpdir/unleash-repo.json"` |
| `customHttpHeader`                         | Add a [custom HTTP header](#custom-http-headers) to the list of HTTP headers that will the client sends to the Unleash API. Each method call will add a new header. | No       | N/A                                  |
...
| `fallbackStrategy`                         | ???                                                                                                                                                                 | No       | `null`                               |
| `fetchTogglesInterval`                     | How often (in seconds) the client should check for toggle updates.                                                                                                  | No       | `10`                                 |
| `instanceId`                               | An identifier for your instance. Typically a hostname, pod id or something similar. Unleash uses this internally for ...something                                   | Yes      | `null`                               |
| `namePrefix`                               | ???                                                                                                                                                                 | No       |                                      |
| `projectName`                              | The name of the Unleash project?                                                                                                                                    | No       |                                      |
| `proxy`                                    | ???                                                                                                                                                                 | No       |                                      |
| `scheduledExecutor`                        | ???                                                                                                                                                                 | No       |                                      |
