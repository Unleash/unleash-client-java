...
class DateConstraintOperatorTest {
  ...
  public void shouldSupportAfterDate() {
    ...
    List<Constraint> constraintList =
        Collections.singletonList(
            new Constraint(
                "releaseDate", Operator.DATE_AFTER, ZonedDateTime.now().minusHours(1).format(ISO)));
  ...
  public void shouldSupportBeforeDate() {
    ...
    List<Constraint> constraintList =
        Collections.singletonList(
            new Constraint(
                "releaseDate", Operator.DATE_BEFORE, ZonedDateTime.now().plusDays(2).format(ISO)));
    Map<String, String> parameters = new HashMap<>();
    // If there's not a date in the defined context field, compare with Instant.now()
  ...
  public void dateBefore() {
    ...
    List<Constraint> c =
        Collections.singletonList(
            new Constraint("currentTime", Operator.DATE_BEFORE, "2022-01-29T13:00:00.000Z"));
    Map<String, String> parameters = new HashMap<>();
