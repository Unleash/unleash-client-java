...
class NumberConstraintOperatorTest {
    ...
    public void shouldSupportEqForNumbers() {
        ...
        List<Constraint> constraintList =
                Collections.singletonList(
                        new Constraint(
                                "userAge", Operator.NUM_EQ, Collections.singletonList("42")));
        Map<String, String> parameters = new HashMap<>();
        UnleashContext ctx =
                UnleashContext.builder().environment("dev").addProperty("userAge", "42").build();
    ...
    public void shouldSupportInvertingNumberEq() {
        ...
        List<Constraint> constraintList =
                Collections.singletonList(
                        new Constraint(
                                "userAge", Operator.NUM_EQ, Collections.singletonList("42"), true));
        Map<String, String> parameters = new HashMap<>();
        UnleashContext ctx =
                UnleashContext.builder().environment("dev").addProperty("userAge", "42").build();
    ...
    public void shouldSupportGreaterThanComparisonForNumbers() {
        ...
        List<Constraint> constraintList =
                Collections.singletonList(
                        new Constraint(
                                "userAge", Operator.NUM_GT, Collections.singletonList("42")));
        Map<String, String> parameters = new HashMap<>();
        UnleashContext enabled =
                UnleashContext.builder().environment("dev").addProperty("userAge", "45").build();
        assertThat(strategy.isEnabled(parameters, enabled, constraintList)).isTrue();
        UnleashContext disabled =
                UnleashContext.builder().environment("dev").addProperty("userAge", "35").build();
    ...
    public void shouldSupportInvertingGreaterThanComparisonForNumbers() {
        ...
        List<Constraint> constraintList =
                Collections.singletonList(
                        new Constraint(
                                "userAge", Operator.NUM_GT, Collections.singletonList("42"), true));
        Map<String, String> parameters = new HashMap<>();
        UnleashContext disabled =
                UnleashContext.builder().environment("dev").addProperty("userAge", "45").build();
        assertThat(strategy.isEnabled(parameters, disabled, constraintList)).isFalse();
    ...
    public void shouldSupportInvertingLesserThanForNumbers() {
        ...
        List<Constraint> constraintList =
                Collections.singletonList(
                        new Constraint(
                                "userAge", Operator.NUM_LT, Collections.singletonList("42"), true));
        Map<String, String> parameters = new HashMap<>();
        UnleashContext disabled =
                UnleashContext.builder().environment("dev").addProperty("userAge", "35").build();
        UnleashContext enabled =
