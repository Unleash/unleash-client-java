...
public class ToggleBackupHandlerFileTest {
    ...
    //                         .build();
    //         ToggleBackupHandlerFile toggleBackupHandlerFile = new
    // ToggleBackupHandlerFile(config);
    //         ToggleCollection toggleCollection = toggleBackupHandlerFile.read();

    //         assertNotNull(
    //                 toggleCollection.getToggle("presentFeature"), "presentFeature should be
    // present");
    //     }
    ...
    //         String staticData =
    //                 "{\"features\": [{\"name\": \"writableFeature\",\"enabled\":
    ...
    //         assertNotNull(
    //                 toggleCollection.getToggle("writableFeature"), "writableFeature should be
    // present");
    //     }
